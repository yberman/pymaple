...
class Procedure(Composite, Expression):
    def __new__(cls, expr, *args):
        ...
        #TODO: make python functions be passable as arguments
        #TODO: implements unnamed unapply (useful? confusing?)
        #      transversing expression looking for all of its arguments
